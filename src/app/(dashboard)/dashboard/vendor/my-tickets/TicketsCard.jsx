        ...
        >
            ...
            >
                <div className="space-y-3">
                    ...
                    <motion.div variants={contentItem} className="grid grid-cols-3 gap-2.5">
                        <InfoBox
                            label="Price"
                            value={
                    ...
                    >
                        <motion.span
                            ...
                            className="shrink-0"
                        >
                            <MdAccessTime className="text-green-500" size={17} />
                        </motion.span>
                ...
                <motion.div variants={contentItem} className="mt-4 grid grid-cols-2 gap-3">
                    {disableActions ? (
                        <Button
                            variant="none"
                            disabled
