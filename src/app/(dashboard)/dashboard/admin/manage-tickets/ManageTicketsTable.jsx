...
const ManageTicketsTable = ({ tickets: initialTickets }) => {
    ...
    const getStatus = (t) =>
        (t?.verificationStatus || "pending").toLowerCase();
        ...
        if (status === "rejected") {
            return (
                <div className={wrap}>
                    ...
                    />
                    <span className="inline-flex items-center gap-1 rounded-xl border border-red-200 bg-red-50 px-3 py-1.5 text-xs font-black text-red-600 dark:border-red-900 dark:bg-red-950/40 dark:text-red-300">
                        <FiXCircle /> Rejected
                    </span>
                </div>
            );
                ...
                <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p className="mt-3 max-w-2xl text-sm leading-6 text-green-50">
                            Review all vendor-submitted tickets. Approve
                            tickets to make them visible on the platform or
                            reject them to keep quality control.
                        </p>
                    </div>
                    ...
                    {filteredTickets.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            {filteredTickets.map((ticket, index) => {
                                ...
                                const StatusIconComp = getStatusIcon(status);
